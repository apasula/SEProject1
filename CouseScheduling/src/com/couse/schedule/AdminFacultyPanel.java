...
public class AdminFacultyPanel extends Panel {
	...
	public void init() {
		...
		tabbedPane.addTab("Add Faculty", new AddFacultyPanel());
		tabbedPane.addTab("Update Faculty", new UpdateFacultyPanel());
		tabbedPane.addTab("Delete Faculty", new DeleteFacultyPanel());
