...
public class ImportStudentsPanel extends Panel {

	private final DefaultTableModel tableModel = new DefaultTableModel();

	public ImportStudentsPanel() {
	...
	public void loadData() {
		new SwingWorker<Void, Void>() {
			...
			protected Void doInBackground() throws Exception {
				...
				studentDB.getNewStudents(tableModel);
				return null;
			}
		}.execute();
	}
	...
	public void init() {
		...
		JLabel fileChooserLabel = new JLabel("Choose STU file");
				...
				if (!fileField.getText().trim().equals("")) {
					...
					SwingWorker<Void, Void> mySwingWorker = new SwingWorker<Void, Void>() {
						...
						protected Void doInBackground() throws Exception {
							...
							ArrayList<StudentCourse> studentCourses = readCSVFile
									.readStudentDetails(fileField.getText()
											.trim());
							for (StudentCourse studentCourse : studentCourses) {
								StudentDB studentDB = new StudentDB();
								studentDB.addStudentDetails(studentCourse);
							}
							uploadButton.setText("Upload");
							uploadButton.setEnabled(true);
							loadData();
							JOptionPane.showMessageDialog(ImportStudentsPanel.this,
									"Data Inserted");
