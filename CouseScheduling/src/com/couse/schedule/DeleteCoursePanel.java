...
public class DeleteCoursePanel extends JPanel{
	...
	public void init(){
		...
		JLabel hint = new JLabel("Delete Course");
		...
		submitbtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				if (courseidtf.getText().trim().equals("")
	            	...
	            	JOptionPane.showMessageDialog(DeleteCoursePanel.this, "Please enter course id");

				} else {
					CourseDB courseDB = new CourseDB();
					courseDB.deleteCourse(courseidtf.getText().trim());
	            	JOptionPane.showMessageDialog(DeleteCoursePanel.this, "Course Deleted");
